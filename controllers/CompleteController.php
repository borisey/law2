...
class CompleteController extends SiteController
{
    public function actionBills()
    {
        ...
        $title = 'Законопроекты, рассмотрение которых завершено | law2.ru';
        $description = 'На сайте представлены проекты федеральных законов, рассмотрение которых завершено';
